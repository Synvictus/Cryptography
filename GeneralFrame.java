...
public class GeneralFrame extends JFrame
{
    ...
    protected JTextArea input = new JTextArea(4, 65);
    ...
    protected JTextArea output = new JTextArea(4, 65);
    JScrollPane outputScroll = new JScrollPane(output, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, 
                                    JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
    // Layouts
    protected FlowLayout layout1 = new FlowLayout(FlowLayout.CENTER);
